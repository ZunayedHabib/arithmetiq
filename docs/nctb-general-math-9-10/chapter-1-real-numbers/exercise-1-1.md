...
.q-body { background: #fff; border: 1px solid #dde3ea; border-top: none; border-radius: 0 0 12px 12px; padding: 1.4rem 1.6rem; box-shadow: 0 3px 10px rgba(0,0,0,.06); margin-bottom: 1rem; }
...
<div class="step-box">
<div class="step-label">Step 1 — Divide 1 by 6 using long division</div>
<div class="step-body arithmatex">
\( 1 \div 6 \): since 1 &lt; 6, write 0. and continue with 10.
\[
\begin{array}{r}
0.1\overline{6} \\[-2pt]
6 \enclose{longdiv}{1.0000} \\
\underline{-\phantom{0}6\phantom{00}} \\
40 \\
\underline{-36} \\
40 \\
\underline{-36} \\
...
\end{array}
\]
The remainder 4 repeats from the second step, so the digit 6 repeats.<br><br>
Therefore \( \dfrac{1}{6} = 0.1\dot{6} \)
</div>
</div>
...
<div class="step-box">
<div class="step-label">Step 2 — Divide 7 by 11 using long division</div>
<div class="step-body arithmatex">
\( 7 \div 11 \): since 7 &lt; 11, write 0. and work with 70.
\[
\begin{array}{r}
0.\overline{63} \\[-2pt]
11 \enclose{longdiv}{7.0000} \\
\underline{-66\phantom{00}} \\
40 \\
\underline{-33} \\
70 \\
\underline{-66} \\
...
\end{array}
\]
After two steps the remainder 70 repeats, so the two-digit block "63" repeats.<br><br>
Therefore \( \dfrac{7}{11} = 0.\dot{6}\dot{3} \)
</div>
</div>
...
\begin{array}{r}
0.5\overline{3} \\[-2pt]
15 \enclose{longdiv}{8.000} \\
\underline{-75\phantom{0}} \\
50 \\
\underline{-45} \\
50 \ldots
\end{array}
\]
The remainder 50 repeats immediately, so only the digit 3 recurs.
\[ \frac{8}{15} = 0.5\dot{3} \]
</div>
</div>
